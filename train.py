...
def main():
    ...
    for epoch in range(start_epoch, config.solver.epochs):
        ...
        for kkk, (prompt_images, list_id) in enumerate((train_loader)):
            ...
            prompt_images = prompt_images.to(device).view(
                -1, c, h, w
            ...
            if kkk % 100 == 0:
                if config.use_motion_loss:
                    print(
                        "Epoch:%d  iteration:%d/%d, total loss:%f, image loss:%f, text loss:%f, motion loss:%f, lr:%f "
                        % (
                            epoch,
                            kkk,
                            len(train_loader),
                    ...
                    print(
                        "Epoch:%d  iteration:%d/%d, total loss:%f, image loss:%f, text loss:%f, lr:%f "
                        % (
                            epoch,
                            kkk,
                            len(train_loader),
